...
The primary goal of this project is to design and evaluate an LLM-based, avatar-supported learning system and to examine how different AI teaching personalities influence learners’ experiences. Specifically, the study investigates how \textbf{empathic} versus \textbf{neutral} AI teaching styles affect learners’ perceptions and learning-related outcomes within an AI-supported learning environment.
\\
To achieve this goal, the project addresses the following research questions:


\begin{itemize}
\item[(1)] \textbf{How do different AI avatar personalities (empathic vs. neutral) affect learners’ perceived empathy and trust toward the system?}
\\
...
\item[(2)] \textbf{Do different AI teaching personalities lead to differences in perceived learning effectiveness?}
\\
...
\item[(3)] \textbf{How does the avatar’s teaching personality influence learner engagement and motivation during the learning process?}
\\
