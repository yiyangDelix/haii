...
\begin{itemize}
\item[(1)] \textbf{Post-intervention knowledge}: The same pre-survey knowledge questions were used for a proper and fair assessment of the knowledge gained after the experiment.


\item[(2)] \textbf{Perceived learning effectiveness}: A total of five questions were asked regarding the clarity, usefulness, and engagement of the avatar to understand the learning effectiveness.

\item[(3)] \textbf{Perceived empathy and emotional support}: This set of questions helped to understand the degree to which the avatar was perceived as understanding and supportive.

\item[(4)] \textbf{Overall user experience}: This section included questions about the satisfaction, trust, and perceived value of the avatar as a learning tool.
