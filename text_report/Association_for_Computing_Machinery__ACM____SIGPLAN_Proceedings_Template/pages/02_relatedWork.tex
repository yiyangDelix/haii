...
\\
Empirical research has reported that the social cues of AIPAs can detectably enhance student engagement\cite{zawacki2019systematic}, motivation\cite{saerbeck2010expressive}, and academic performance\cite{fredricks2004engagement}. The findings showed that such affective pedagogical agents can promote learners' positive emotions, motivation, and overall academic outcomes.
